...
import pytest
from source_factorial.source import FactorialStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(FactorialStream, "path", "v0/example_endpoint")
    mocker.patch.object(FactorialStream, "primary_key", "test_primary_key")
    mocker.patch.object(FactorialStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = FactorialStream()
